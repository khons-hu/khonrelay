...
export const questions = {
 ...
 suppress:q('Is this item an experimental prerelease OR a service-status incident report explicitly marked resolved? A software release that fixes a bug is NOT a resolved service-status incident. Routine changes are evaluated separately by the impact question.')
};
